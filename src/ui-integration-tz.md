...
Статус на 2025-10-08 — 🟡 (в процессе, ≥50%)
...
- Гейты: Tests PASS (25/25), Typecheck PASS, Build PASS (CSS предупреждения не блокируют).
- Следующее: добавить smoke-тесты действий (ручной запуск recovery и создание backup), и UX‑улучшения (переключение RU/EN на вкладках).
